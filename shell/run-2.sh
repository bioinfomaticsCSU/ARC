...
for ((i=0;i<${#arra[@]};i++))
    ...
    then
       var=`echo "${arra[$i]}"|awk -F '=' '{print $2}' `
       Read_jump_length=$var
       echo "Read_jump_length="$var
    fi
    if [ $i = 5 ] 
    then 
       var=`echo "${arra[$i]}"|awk -F '=' '{print $2}' `
    ...
    then 
       var=`echo "${arra[$i]}"|awk -F '=' '{print $2}' `
       bless_jump_kmerlength=$var
       echo "bless_jump_kmerlength="$var
    fi
...
javac  $home/Program/GenerateConfigFile2.java
java -classpath  $home/Program/ GenerateConfigFile2 $home/Run-config.txt $home/ConfigFile/ $home
...
for ((i1=0;i1<${#arra1[@]};i1++))
    ...
    then
       ...
       then
          ...
          bless  -read $home/lib/$lib2_left_name.fastq  -prefix  $home/lib/$lib2_left_name  -kmerlength  $bless_jump_kmerlength
       else
    ...
    then
       ...
       then
          ...
          bless  -read $home/lib/$lib2_right_name.fastq -prefix  $home/lib/$lib2_right_name  -kmerlength  $bless_jump_kmerlength
       else
...
java -classpath  $home/Program/ GenerateFastaFromFastqFiles     $home/lib/$lib1_left_name.fastq $home/lib/$lib1_right_name.fastq $home/lib/
java -classpath  $home/Program/ GenerateFastaFromFastqFilesLong $home/lib/$lib2_left_name.fastq $home/lib/$lib2_right_name.fastq $home/lib/
java -classpath  $home/Program/ GenerateFastaFromFastqFilesLongJump $home/lib/$lib3_left_name.fastq $home/lib/$lib3_right_name.fastq $home/lib/
...
echo  "---> SOAP2 before"
SOAPdenovo-127mer all -L 101 -p 16 -s $home/ConfigFile/before.lib -K $Soap2_kmerlength -R -o $home/AssemblyResults/SOAP2/before/before 1>$home/Log/SOAP2/Assembly_before 2>$home/Log/SOAP2/Assembly_Error_before
echo  "SOAP2 before Successful end!"
cd $Abyss_bin
echo  "---> Abyss before"
abyss-pe k=$Abyss_k l=$Abyss_l n=$Abyss_n s=$Abyss_s name=$Abyss_name  in="$home/lib/$lib1_left_name.fastq $home/lib/$lib1_right_name.fastq $home/lib/$lib2_left_name.fastq $home/lib/$lib2_right_name.fastq" > $home/Log/Abyss/Abyss_assembly_before.log
...
java -classpath  $home/Program/ FilterKmerStaticsALong $home/AssemblyResults/Abyss/before/scaffolds.fa $home/lib/short2.fasta $home/KmerFreStatics/ $Read_jump_length $dsk_kmerlength
...
java -classpath  $home/Program/ GenerateReadSetByKmerFreThreadModifyLong_Left $home/lib/ $home/KmerFreStatics/RepeatKmer.short2.txt $home/KmerFreStatics/LowFreKmer.short2.txt $home/NormalReadPartitions/ $home/NormalReadPartitions/  $home/NormalReadPartitions/  $Read_jump_length  $dsk_kmerlength 
echo  "---> right short2"
java -classpath  $home/Program/ GenerateReadSetByKmerFreThreadModifyLong_Right $home/lib/ $home/KmerFreStatics/RepeatKmer.short2.txt $home/KmerFreStatics/LowFreKmer.short2.txt $home/NormalReadPartitions/ $home/NormalReadPartitions/  $home/NormalReadPartitions/ $Read_jump_length  $dsk_kmerlength
...
java  -classpath  $home/Program/ FilterLowAndHighFreReadLong $home/NormalReadPartitions/NormalReadSet_short2_left.fasta $home/NormalReadPartitions/NormalReadSet_short2_right.fasta  $home/NormalReadPartitions/ $Read_jump_length
#SOAP2 start.
echo  "*****************************************************************************"
echo  " "
echo  "*****************************************************************************"
...
./GapCloser -a $home/AssemblyResults/SOAP2/after+filter/afterfilter.scafSeq  -b $home/ConfigFile/gapcloser.lib -o $home/AssemblyResults/SOAP2/after+filter/afterfilter2.scafSeq -p 13 -t 16 
...
#gapcloser before.
./GapCloser -a $home/AssemblyResults/SOAP2/before/before.scafSeq  -b $home/ConfigFile/gapcloser.lib -o $home/AssemblyResults/SOAP2/before/before2.scafSeq -p 13 -t 16 
echo  "gapcloser Successful end!"
#regenerate contig.
echo  "scaff2contig begin!"
cd $home/GapCloser-bin-v1.12-r6
...
abyss-map $lib1 $lib2 $lib3 $lib4 contigs.fa | abyss-fixmate -h lib.0.hist | sort -snk3 -k4 | DistanceEst --dot --mean -k$Abyss_k -s$Abyss_s -n$Abyss_n -o lib.0.dist.dot lib.0.hist
