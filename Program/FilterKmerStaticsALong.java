...
public class FilterKmerStaticsALong {
	...
	public static void main(String[] args) throws IOException {
		...
		//Loading.
		String kmerstatisiticfile=KmerFrePath+"/KmerFreStaticsFile.short2.txt";
        ...
        File readfile = new File(KmerFrePath+"KmerFreStaticsFile.short2.txt");
        if (readfile.isFile() && readfile.exists()) 
		{
               ...
               bufferedReader.close();
			   //Filter Repeat.
	           BufferedWriter FilterRepeat = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(KmerFrePath+"FilterRepeat.short2.txt"),encoding)); 
               FilterRepeat.write(AfterFilterRepeatStr);
               FilterRepeat.close();
               //Filter Normal
               BufferedWriter FilterNormal = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(KmerFrePath+"FilterNormal.short2.txt"),encoding)); 
               FilterNormal.write(AfterFilterNormalStr);
               FilterNormal.close();
               //Filter LowFre.
	           BufferedWriter FilterLowFre = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(KmerFrePath+"FilterLowFre.short2.txt"),encoding)); 
