...
public class GenerateFastaFromFastqFiles {
	...
	public static void main(String[] args) throws IOException {
		...
		{
			FileWriter writer= new FileWriter(OutPutPath+"short1.left.fasta",true);
		...
		{
			FileWriter writer= new FileWriter(OutPutPath+"short1.right.fasta",true);
		...
		{
			FileWriter writer= new FileWriter(OutPutPath+"short1.fasta",true);
            writer.write(">"+(Num++)+"\n"+short_1_A_Array[m]+"\n"+">"+(Num++)+"\n"+short_1_B_Array[m]+"\n");
            writer.close();
		}
	}
