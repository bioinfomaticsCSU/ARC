...
public class GenerateConfigFile3 {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    for(int i=0;i<RealSizeOfFileSetArray;i++)
	    {
			...
			{
			    String [] SplitLine = FileSetArray[i].split("=");
	    		    lib3_left=SplitLine[1];
			}
			if(i==17)
			{
			    String [] SplitLine = FileSetArray[i].split("=");
	    		    lib3_right=SplitLine[1];
			}
	    }
	    //Write gapreduce.
       ...
       out0.close();
		//Write before.
	    write_after="[LIB]"+"\n"+"max_rd_len="+readlength1+"\n"+"avg_ins="+insertsize1+"\n"+"reverse_seq=0"+"\n"+"asm_flags=3"+"\n"+"rank=1"+"\n"+"q1="+HomePath+"/lib/"+lib1_left+".corrected.fastq"+"\n"+"q2="+HomePath+"/lib/"+lib1_right+".corrected.fastq"+"\n"+"[LIB]"+"\n"+"[LIB]"+"\n"+"max_rd_len="+readlength2+"\n"+"avg_ins="+insertsize2+"\n"+"reverse_seq=1"+"\n"+"asm_flags=3"+"\n"+"rank=2"+"\n"+"q1="+HomePath+"/lib/"+lib2_left+".corrected.fastq"+"\n"+"q2="+HomePath+"/lib/"+lib2_right+".corrected.fastq"+"\n"+"[LIB]"+"\n"+"max_rd_len="+readlength3+"\n"+"avg_ins="+insertsize3+"\n"+"reverse_seq=1"+"\n"+"asm_flags=3"+"\n"+"rank=3"+"\n"+"q1="+HomePath+"/lib/"+lib3_left+".corrected.fastq"+"\n"+"q2="+HomePath+"/lib/"+lib3_right+".corrected.fastq"+"\n";
