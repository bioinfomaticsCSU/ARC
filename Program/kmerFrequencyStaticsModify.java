...
public class kmerFrequencyStaticsModify {
	...
	public static void main(String[] args) throws IOException {
		...
		String encoding="utf-8";
		String Context="";
		int SizeOfDSK=getDSKLine(DSKPath+"short1.txt");
		int ratio=100;
		int SumCountFre=0;
		double SumRate=0.0;
		String KmerSetArray[]=new String[SizeOfDSK];
		int KmerSetArraySize=readDSKFile(DSKPath+"short1.txt",KmerSetArray);
		...
		BufferedWriter out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(KmerStaticsFile+"KmerFreStaticsFile.short1.txt"),encoding)); 
		out.write(Context);
		out.close();
