...
public class GenerateFastaFromFastqFilesLongJump {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    System.out.println("The size of short_3_A_Array is:"+scount_short_1_A);
		//Left File.
		int Short1_NumLeft=0;
		for(int j=0;j<scount_short_1_A;j++)
		{
			FileWriter writer= new FileWriter(OutPutPath+"short3.left.fasta",true);
	    ...
	    System.out.println("The size of short_3_B_Array is:"+scount_short_1_B);
		int Short1_NumRight=0;
		for(int j=0;j<scount_short_1_B;j++)
		{
			FileWriter writer= new FileWriter(OutPutPath+"short3.right.fasta",true);
		...
		{
			FileWriter writer= new FileWriter(OutPutPath+"short3.fasta",true);
            writer.write(">"+(Num++)+"\n"+short_1_A_Array[m]+"\n"+">"+(Num++)+"\n"+short_1_B_Array[m]+"\n");
            writer.close();
		}
	}
