...
public class FilterLowAndHighFreRead {
	...
	// TODO Auto-generated method stub
        ...
        for(int t=0;t<CountLeft;t++)
        {
        	if(ReadSetArrayLeft[t].charAt(0)=='#')
        	{
        	    ...
        	    {
			        FileWriter writer= new FileWriter(NormalReadSetPath+"AbnormalReadSet_short1.fasta",true);
                    ...
                    writer.close(); 
					//
			        FileWriter writer2= new FileWriter(NormalReadSetPath+"ReadSet_short1.LowFre.fasta",true);
        	    ...
        	    else if(ReadSetArrayRight[t].charAt(0)=='$')
        	    {
                    ...
                    writer.close();
					//
					FileWriter writer3= new FileWriter(NormalReadSetPath+"ReadSet_short1.LowFre.fasta",true);
                    writer3.write(">"+(LowNum)+"\t"+"left"+"\n"+ReadSetArrayLeft[t].substring(1,ReadSetArrayLeft[t].length())+"\n"+">"+(LowNum++)+"\t"+"right"+"\n"+FillStr+"\n");
                    writer3.close();
					//
					FileWriter writer8= new FileWriter(NormalReadSetPath+"ReadSet_short1.HighFre.fasta",true);
        	    ...
        	    else if(ReadSetArrayRight[t].charAt(0)!='#' && ReadSetArrayRight[t].charAt(0)!='$')
        	    {
                    ...
                    writer.close(); 
                    //
					FileWriter writer4= new FileWriter(NormalReadSetPath+"ReadSet_short1.LowFre.fasta",true);
           ...
           else if(ReadSetArrayLeft[t].charAt(0)=='$')
           {
          	    if(ReadSetArrayRight[t].charAt(0)=='$')
        	    {
                    ...
                    writer.close(); 
					//
					FileWriter writer5= new FileWriter(NormalReadSetPath+"ReadSet_short1.HighFre.fasta",true);
        	    ...
        	    else if(ReadSetArrayRight[t].charAt(0)=='#')
        	    {
                    ...
                    writer.close();
					//
					FileWriter writer6= new FileWriter(NormalReadSetPath+"ReadSet_short1.LowFre.fasta",true);
                    writer6.write(">"+(LowNum)+"\t"+"left"+"\n"+FillStr+"\n"+">"+(LowNum++)+"\t"+"right"+"\n"+ReadSetArrayRight[t].substring(1,ReadSetArrayRight[t].length())+"\n");
                    writer6.close();
					//
					FileWriter writer9= new FileWriter(NormalReadSetPath+"ReadSet_short1.HighFre.fasta",true);
        	    ...
        	    else if(ReadSetArrayRight[t].charAt(0)!='#' && ReadSetArrayRight[t].charAt(0)!='$')
        	    {
                    ...
                    writer.close(); 
					//
					FileWriter writer4= new FileWriter(NormalReadSetPath+"ReadSet_short1.HighFre.fasta",true);
		   ...
		   else if(ReadSetArrayLeft[t].charAt(0)!='#' && ReadSetArrayLeft[t].charAt(0)!='$')
		   {
        	    ...
        	    else if(ReadSetArrayRight[t].charAt(0)=='$')
        	    {
                    ...
                    writer.close();
					//
					FileWriter writer3= new FileWriter(NormalReadSetPath+"ReadSet_short1.HighFre.fasta",true);
       ...
       for(int r=0;r<CountLeft;r++)
       {
    	   ...
    	   {
			   FileWriter writer= new FileWriter(NormalReadSetPath+"ReadSet_short1.Filter.fasta",true);
               writer.write(">"+r+"\n"+ReadSetArrayLeft[r]+"\n"+">"+r+"\n"+ReadSetArrayRight[r]+"\n");
               writer.close();
    	   }
       } 
